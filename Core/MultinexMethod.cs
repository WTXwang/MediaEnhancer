...
/// <summary>
/// Multinex 低光照增强（ONNX 推理），44K 参数。
/// MaxInferenceSize=480 时全屏增强接近实时（~10-30ms CPU）。
/// </summary>
public class MultinexMethod : IRealTimeEnhancer, IOnnxEnhancement
{
    private InferenceSession? _session;
    private readonly object _lock = new();

    public string Name => "Multinex 低光增强";
    public string Description => "基于 Retinex 理论的低光照增强，可降采样实时推理";
    ...
    // IOnnxEnhancement
    public string ModelFileName => "multinex_lolv1.onnx";
